...
namespace ChatbotML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\AJEET\github.com\ChatBot\chatbot\data.csv";
        private static string MODEL_FILEPATH = @"C:\Users\Centrecom\AppData\Local\Temp\MLVSTools\chatbotML\chatbotML.Model\MLModel.zip";
